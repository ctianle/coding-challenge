...
import (
	...
	crudechainmodulev1 "crudechain/api/crudechain/crudechain/module"
	_ "crudechain/x/crudechain/module" // import for side-effects
	crudechainmoduletypes "crudechain/x/crudechain/types"
